...
export const projectsData = [
  ...
  },
  {
    ...
    img: 'project2.jpg',
    title: 'Медиа НИУ ВШЭ',
    info: 'Выпуск корпоративного медиа Управления академического развития для сотрудников университета. В мои задачи входило согласование тем, редактура текстов, разработка инфосхем, рассылки и посты, работа с иллюстраторами и дизайнерами.',
    info2: '',
